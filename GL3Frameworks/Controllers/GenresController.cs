...
namespace GL3Frameworks.Controllers
{
    public class GenresController : Controller
    {
        ...
        public GenresController(GL3FrameworksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genre != null ? 
                          ...
                          Problem("Entity set 'GL3FrameworksContext.Genre'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GL3FrameworksContext.Genre'  is null.");
            }
            var genre = await _context.Genre.FindAsync(id);
            if (genre != null)
            {
